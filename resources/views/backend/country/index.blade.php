		...
		<div class="row">
			...
			<div class="col-12">
				<div class="main__title">
                    ...
                    <a href="{{ route('admin.country.create') }}" class="main__title-link">Thêm mới</a>
				</div>
			</div>
			<!-- end main title -->
						...
						<tbody>
                            @foreach($list as $key => $country)
							    <tr>
                                    ...
                                    <td>
                                        <div class="main__table-text">{{$country->title}}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">{{$country->description}}</div>
                                    </td>
                                    <td>
                                        @if($country->status == 1)
                                    ...
                                    <td>
                                        <div class="main__table-text">{{$country->slug}}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-btns">
                                            <a href="{{route('admin.country.edit',$country->id)}}" class="main__table-btn main__table-btn--edit">
                                            ...
                                            @if($country->status == 0)
                                                {!! Form::open(['route' => ['admin.country.destroy',$country->id], 'method' => 'DELETE']) !!}
