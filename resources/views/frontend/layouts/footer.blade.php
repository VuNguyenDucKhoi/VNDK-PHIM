	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 col-md-3">
				<h6 class="footer__title">App</h6>
				<ul class="footer__app">
					<li><a href="#"><img src="/template/img/Download_on_the_App_Store_Badge.svg" alt=""></a></li>
					<li><a href="#"><img src="/template/img/google-play-badge.png" alt=""></a></li>
				</ul>
			</div>
			<!-- end footer list -->
			...
			<div class="col-12 col-sm-4 col-md-3">
				...
				<ul class="footer__list">
					<li><a href="mailto:support@flixgo.com">vndkphim@gmail.com</a></li>
				</ul>
			...
			<div class="col-12">
				<div class="footer__copyright">
					<small>© VNDKPHIM, 2022. Create by <a href="#" target="_blank" rel="noopener">.JDK</a>.</small>
