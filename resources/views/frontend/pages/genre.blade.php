		...
		<div class="row">
			<div class="col-12">
				<div class="section__wrap">
					<!-- section title -->
					<h1 class="section__title">Phim {{$gen_slug->title}}</h1>
					<!-- end section title -->

					<!-- breadcrumb -->
					<ul class="breadcrumb">
						<li class="breadcrumb__item"><a href="{{ route('home') }}">Trang chủ</a></li>
						<li class="breadcrumb__item breadcrumb__item--active">Phim {{$gen_slug->title}}</li>
					</ul>
					<!-- end breadcrumb -->
				</div>
			</div>
                        ...
                        <div class="card__content">
                            ...
                            <span class="card__category">
                                @if($mov->category_id == 19)
                                    <div style="font-weight: 700; line-height: 100%; color: rgba(255,255,255,0.65); font-size: 12px; border: 1px solid rgba(255,255,255,0.16); padding: 5px 5px 4px; border-radius: 4px;">
                                        Tập: 15 / 40
                                    </div>
                                @else
                                    <div style="font-weight: 700; line-height: 100%; color: rgba(255,255,255,0.65); font-size: 12px; border: 1px solid rgba(255,255,255,0.16); padding: 5px 5px 4px; border-radius: 4px;">
